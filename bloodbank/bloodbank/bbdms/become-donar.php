...
<head>
    ...
    <title>BloodBank Management System | Donate</title>
...
<div><input type="text" name="mobileno" class="form-control" onKeyPress="return isNumberKey(event)" pattern="\d{10}" required maxlength="10" ></div>
</div>
<div class="col-lg-4 mb-4">
...
<div><input type="text" name="age" class="form-control" pattern="\d{10}" required></div>
</div>
